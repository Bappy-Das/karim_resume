      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {portfolioData.education.map((edu, idx) => (
            <div
              key={idx}
              className="p-6 sm:p-7 rounded-2xl glass-card relative overflow-hidden group hover:border-emerald-500/30 flex flex-col justify-between"
            >
              {/* Glow Accent */}
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm font-semibold text-emerald-400 mt-1 font-mono">
                    {edu.institution}
                  </p>
                </div>
